...
if (isset($_GET['id'])) {
    ...
    // SQL untuk mengambil data penyakit berdasarkan ID
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($image)) {
        $sql = "UPDATE penyakit SET name='$name', tanggal='$tanggal', description='$description', image='$image' WHERE id='$id'";
    } else {
        $sql = "UPDATE penyakit SET name='$name', tanggal='$tanggal', description='$description' WHERE id='$id'";
    }

    if ($conn->query($sql) === TRUE) {
        // Mengarahkan kembali ke halaman penyakit dengan pesan sukses
        header("Location: penyakit.php?edit_success=true");
        exit();
    } else {
...
<head>
    ...
    <title>Edit Materi Penyakit</title>
    ...
    <div class="container">
        ...
        <div class="main-content">
            ...
            <div class="form-container">
                <form method="POST" action="edit-penyakit.php" enctype="multipart/form-data">
