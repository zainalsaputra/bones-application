        ...
        <div class="main-content">
            <header>
                ...
                <div class="header-actions">
                    ...
                    <a href="add-otot.html" class="button">
                        <img src="asset/add.png" alt="Tambah otot">
                    </a>
                </div>
            </header>
            <div class="order-table">
                <table>
                    ...
                    <tbody id="ototTableBody">
                        <!-- Data otot dari Database -->
                        <?php
                            ...
                            while($row = $result->fetch_assoc()) {
                                ...
                                echo "<td>
                                        <div class='action-buttons'>
                                            <a href='edit-otot.php?id=" . $row['id'] . "'><img src='asset/edit.png' alt='Edit' style='width: 30px; height: 30px;'></a>
                                            <a href='delete_otot.php?id=" . $row['id'] . "' onclick='return confirm(\"Are you sure you want to delete this item?\");'><img src='asset/remove.png' alt='Hapus' style='width: 30px; height: 30px;'></a>
                                        </div>
                                      </td>";
                                echo "</tr>";
                            }
                        } else {
                            echo "<tr><td colspan='6'>Tidak ada data otot</td></tr>";
                        }
                        $conn->close();
                        ?>
                    </tbody>
        ...
        document.addEventListener('DOMContentLoaded', (event) => {
            if (window.location.search.includes('delete_success=true')) {
                ...
                if (id) {
                    ...
                    // Renumber rows
                    const rows = document.querySelectorAll('#ototTableBody tr');
